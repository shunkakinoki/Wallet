  ...
  public var body: some View {
    ...
    VStack(alignment: .leading, spacing: 0) {
      VStack(alignment: .leading, spacing: 12) {
        ...
        Text("Start by adding your wallet, a new home for your web3 activites.").font(
          .system(size: 16)
      ...
      VStack(spacing: 0) {
        ZStack {
          HStack(spacing: 10) {
            ColoredIconView(
              imageName: "plus.circle", foregroundColor: Color(.white),
        ...
        ZStack {
          NavigationLink(
              ...
              VStack(spacing: 0) {
                ...
                VStack(spacing: 16) {
                  ...
                  NavigationLink(destination: ImportPrivateKeyView()) {
                    ImportViewCategoryItem(
                      icon: "key.fill", color: Color(Colors.System.orange),
            ...
            HStack(spacing: 10) {
              ColoredIconView(
                imageName: "square.and.arrow.down", foregroundColor: Color(.white),
      ...
      VStack(alignment: .leading, spacing: 0) {
        ...
        VStack(alignment: .leading) {
          FeatureDetail(
            image: "safari.fill", title: "Safari Extension",
            description:
              "Instant access to all dapps, at the convenience of your fingertips inside the Safari browser."
          )
          FeatureDetail(
            image: "lock.shield.fill", title: "Security",
            description: "Secure your funds & assets using Apple's native Secure Encalve.")
          FeatureDetail(
            image: "checkmark.seal.fill", title: "Open Source & Native",
            description:
              "We believe in a privacy focused, open & transparent, native wallet infrastructure for Ethereum."
          )
        }
