...
public final class KeychainWrapper: SecureKeychain {
    ...
    public func SecKeyCreateEncryptedData(_ key: SecKey, _ algorithm: SecKeyAlgorithm, _ plaintext: CFData,  error: UnsafeMutablePointer<Unmanaged<CFError>?>) -> CFData? {
        Security.SecKeyCreateEncryptedData(key, algorithm, plaintext, error)
    }

    public func SecKeyCreateDecryptedData(_ key: SecKey, _ algorithm: SecKeyAlgorithm, _ plaintext: CFData,  error: UnsafeMutablePointer<Unmanaged<CFError>?>) -> CFData? {
