...
extension EthereumAccount {
  ...
  func updateIndex(with address: String) throws -> Int {
    if let indexes = try UserDefaults.standard.get(
      objectType: Dictionary<Int, String>.self, forKey: "accountAddresses")
    {
  ...
  private func updateAddressIndex(_ indexes: [Int: String], index: Int, address: String) throws
    -> Int
  {
    var indexToSave = indexes
