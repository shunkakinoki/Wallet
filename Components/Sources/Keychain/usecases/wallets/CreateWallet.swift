...
public final class CreateWalletImp: CreateWallet {
    ...
    public func create() throws {
        ...
        try importKeyStore.keyStore(newWallet.privateKey, publicKey: newWallet.publicKey, type: .derivedWallet)
...
extension CreateWalletImp {
    private func generateNewWallet(with seedKeyStore: SeedKeyStore) throws -> (privateKey: Data, publicKey: PublicKey, address: String) {
        ...
        let privateKey = try mnemonic.generateExternalPrivateKey(at: UInt32(seedKeyStore.addresses.count))
