...
struct TransactionMetadata {
    ...
    static func getMetadata(to: EthereumAddress, from: EthereumAddress, value: Data) async throws -> (BigUInt, BigUInt, BigUInt) {
        ...
        let estimate = try await getGas.estimate(to: to.eip55Description,
        ...
        guard let intPrice = BigUInt(price.noHexPrefix, radix: 16),
              ...
              let intTransactionCount = BigUInt(transactionCount.noHexPrefix, radix: 16) else {
